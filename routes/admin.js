...
function ensureAuthorized(req, res, next) {
    ...
    if (req.headers.authorization == CONFIG.SECRET_KEY) { next(); return; }
...
module.exports = function (app, io) {
    try {
        ...
        var users = require('../controller/admin/users.js')(app, io);
        ...
        var taskerdocuments = require('../controller/admin/taskerdocuments.js')(app);

        /** ROUTERS for admin **/
        app.post('/admin', admins.login);
        app.get('/admin-logout', admins.logout);
        ...
        app.post('/users/remove', ensureAuthorized, users.remove);
        ...
        app.post('/taskers/remove', ensureAuthorized, taskers.remove);
        ...
        app.post('/taskers/updatetaskerstatus', ensureAuthorized, taskers.updatetaskerstatus);
        ...
        app.post('/taskers/stripe-connect', ensureAuthorized, taskers.stripeConnect);

        app.post('/taskerdocuments/save', taskerdocuments.save);
        app.post('/taskerdocuments/allDocument', taskerdocuments.allDocument);
        app.post('/taskerdocuments/edit', taskerdocuments.edit);
        app.post('/taskers/taskerDocumentUpload', middlewares.commonUpload(CONFIG.DIRECTORY_OTHERS_TASKER).any(), taskers.taskerDocumentUpload);
        app.post('/taskers/taskerDocument', ensureAuthorized, taskers.taskerDocuments);
        app.post('/taskers/taskerDocumentEdit', ensureAuthorized, middlewares.commonUpload(CONFIG.DIRECTORY_OTHERS_TASKER).any(), taskers.taskerDocumentEdit);
        app.post("/taskers/taskerDocumentDelete", ensureAuthorized, taskerdocuments.delete)
        ...
        app.post('/images/save', ensureAuthorized, middlewares.commonUpload(CONFIG.DIRECTORY_OTHERS).fields([{ name: 'backgroundimage', maxCount: 1 }, { name: 'taskersignup', maxCount: 1 }, { name: 'adminlogin', maxCount: 1 }, { name: 'loginpage', maxCount: 1 }, { name: 'taskerprofile', maxCount: 1 }, { name: 'bannerpage', maxCount: 1 }]), images.save);
        ...
        app.post('/email-template/getTemplateByName', ensureAuthorized, emailTemplate.getTemplateByName);
        ...
        app.post('/categories/updatePriority', ensureAuthorized, categories.updatePriority);
        ...
        app.post('/tools/exportsubscriber', ensureAuthorized, tools.subscriberexportpost);
        ...
        app.post('/settings/currency/currencyDoller', ensureAuthorized, settings.currencyUSD);
        ...
        app.post('/settings/filecontent/save', ensureAuthorized, middlewares.customUpload(CONFIG.DIRECTORY_CONFIG).fields([{ name: 'user', maxCount: 1 }, { name: 'tasker', maxCount: 1 }]), settings.filesave);
        ...
        app.post('/settings/language/download', ensureAuthorized, settings.languageDownload);
        app.post('/settings/language/add', ensureAuthorized, settings.languageAdd);
        app.post('/settings/language/languageWrite', ensureAuthorized, settings.languageWrite);
        app.post('/settings/language/mobile', ensureAuthorized, settings.getmobilelanguageDetails);
        app.post('/settings/language/multideletecontent', ensureAuthorized, settings.multideletelanguageDetails);
        app.post('/settings/language/deletecontent', ensureAuthorized, settings.deletelanguageDetails);
        app.post('/settings/language/mobiletranslation/save', ensureAuthorized, settings.languagemobileSaveTranslation);
        ...
        app.get('/dashboard/dashboard-stats', dashboard.dashboardStats);
        ...
        app.post('/dashboard/forgotpass', admins.forgotpass);
        app.post('/dashboard/forgotsave', admins.forgotpassave);
        ...
        app.post('/posttask/list', ensureAuthorized, posttask.list);
        ...
        app.post('/peoplecmd/list', ensureAuthorized, peoplecmd.list);
        ...
        app.get('/admin/download-file/:type/:file', tools.downloadFile);
