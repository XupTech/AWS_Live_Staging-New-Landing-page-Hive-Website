...
function TaskersService($http, $q, Upload) {
    ...
    var TaskersService = {
        ...
        editDocumentCall: editDocumentCall,
        taskerDocumentService: taskerDocumentService,
        taskerDocumentUpload: taskerDocumentUpload,
        taskerDocumentEdit: taskerDocumentEdit,
    ...
    */
    ...
    function exporttaskerData(tasker,status) {        
        var deferred = $q.defer();
        $http({
            method: 'POST',
    ...
    function getAllDocument(status, limit, skip, sort, search) {
        var deferred = $q.defer();
        var data = {};
        data.status = status;
        data.sort = sort;
        ...
        $http({
            method: 'POST',
            url: '/taskerdocuments/allDocument',
            data: data
        }).success(function (data) {
            deferred.resolve(data);
        }).error(function (err) {
    ...
    function editDocumentCall(data) {
        var deferred = $q.defer();
        $http({
            method: 'POST',
            url: '/taskerdocuments/save',
            data: data,
        }).then(function (data) {
            deferred.resolve(data);
        }, function (err) {
    ...
    function taskerDocumentService(data) {
        var deferred = $q.defer();
        $http({
            method: 'post',
            url: '/taskers/taskerDocument',
            data: data
        }).then(function (data) {
             deferred.resolve(data);
        }, function (err) {
    ...
    function taskerDocumentUpload (data) {
        var deferred = $q.defer();
        Upload.upload({
            method: 'post',
            url: '/taskers/taskerDocumentUpload',
            data: data
        }).then(function (data) {
            deferred.resolve(data);
        }, function (err) {
    ...
    function taskerDocumentEdit (data) {
        var deferred = $q.defer();
        Upload.upload({
            method: 'post',
            url: '/taskers/taskerDocumentEdit',
            data: data
        }).then(function (data) {
            deferred.resolve(data);
        }, function (err) {
    ...
    function stripeConnect(data) {
        var deferred = $q.defer();
        $http({
            method: 'POST',
            url: '/taskers/stripe-connect',
            data: data
        }).success(function (data) {
            deferred.resolve(data);
        }).error(function (err) {
