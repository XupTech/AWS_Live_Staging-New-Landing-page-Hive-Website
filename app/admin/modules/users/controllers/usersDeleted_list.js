...
function trashUserListCtrl(trashUserServiceResolve, $scope, UsersService, $rootScope) {
    ...
    tulc.table.delete = {
        ...
        'date': $scope.date,
        service: '/users/remove', getData: function (currentPage, itemsPerPage, sort, status, search) {
            if (currentPage >= 1) {
