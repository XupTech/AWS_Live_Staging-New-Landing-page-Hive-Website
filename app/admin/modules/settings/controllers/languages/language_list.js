...
function languageSettingsListCtrl(languageServiceListResolve, languageService, MainService, toastr, $window, $modal, $scope) {
    ...
    var layout = [
...

        {
            ...
            '<button class="btn btn-info btn-rounded btn-ef btn-ef-5 btn-ef-5b" ng-if="options.permission.edit != false" ui-sref="app.settings.languageSettings.mobile({langId:content.code})"><i class="fa fa-edit"></i> <span>Mobile</span></button>' +
