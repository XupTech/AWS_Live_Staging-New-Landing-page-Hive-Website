...
function AuthenticationService($http, $cookieStore, $rootScope, toastr, $q, $cookies, Upload, socket, notify) {
    ...
    service.taskersociallogin = function (data, callback) {

        var deferred = $q.defer();
        $http({
            method: 'post',
            url: '/site/taskersociallogin',
            data: data
        }).then(function (response) {
            deferred.resolve(response.data);
        }, function (err) {
    ...
    service.taskerDocumentUpload = function (value) {
        var deferred = $q.defer();
        Upload.upload({
            method: 'post',
            url: '/site/users/taskerDocumentUpload',
            data: value
        }).then(function (data) {
            deferred.resolve(data);
        }, function (err) {
    ...
    service.taskerDocumentService = function (data) {
        var deferred = $q.defer();
        $http({
            method: 'post',
            url: '/site/users/taskerDocument',
            data: data
        }).then(function (data) {
             deferred.resolve(data);
        }, function (err) {
