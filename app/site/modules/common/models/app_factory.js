...
function MainService($http, $q) {
    var mainService = {
        getData: getData,
        getPostheaderPosttask: getPostheaderPosttask,
        ...
        generateotpface:generateotpface,
        socialupdatelog:socialupdatelog
    };
    return mainService;
    ...
    function getPostheaderPosttask(config, data) {
        if (data.skip > 1) {
            data.skip = (parseInt(data.skip) - 1) * data.limit;
        } else {
            data.skip = 0;
    ...
    function getTransalatePage(pageId, languagename, _id, role, code) {
        var deferred = $q.defer();
        var data = {};
        data.page = pageId;
    ...
    function generateotpface(data) {
        var deferred = $q.defer();
        $http({
            method: 'POST',
            url: '/site/generateotpface',
            data: data
        }).then(function (data) {
            deferred.resolve(data.data);
        }, function (err) {
    ...
    function socialupdatelog(data) {
        var deferred = $q.defer();
        $http({
            method: 'POST',
            url: '/site/socialupdatelog',
            data: data
        }).then(function (data) {
            deferred.resolve(data.data);
        }, function (err) {
