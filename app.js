...
i18n.configure({ locales: ['en', 'fr'], defaultLocale: 'en', autoReload: true, directory: __dirname + '/uploads/locales', syncFiles: true });
/** /Global Configuration*/

/** MongoDB Connection */
mongoose.connect(CONFIG.DB_URL, { useMongoClient: false });
